...
- 控制区
  ...
  - 筛选：渠道筛选（多选）、分类筛选、时间范围（今天 / 近 2 小时）
  - 搜索框：按标题/摘要关键词
  - 视图密度（可选）
- 列表区（主内容）
  - 每条 Item 一行/一卡，倒序排列
...
| 功能条目 | 56 | **25**（F-080~F-107） | 0（**就地改** F-071/F-083/F-084） | **81** |
| 优先级分布 | P0=33 / P1=17 / P2=6 | P0=14 / P1=9 / P2=2 | 不变 | P0=47 / P1=26 / P2=8 |
| 页面 | 3 | **+1**（页面4） | — | 4 |
| 待确认问题 | Q1~12（12） | **+7**（Q13~Q19） | **Q13 已定**、**+Q20** | 20（其中 Q13 已定） |
